...
<div class="top">
  ...
  <form:form action="${fillDriversDataAction}" commandName="user">
    <table class="big_table">
      ...
      <tr>
        <td class="big_table_label"><form:label path="eMail"><spring:message text="e-mail"/></form:label></td>
        <td class="big_table_input"><form:input path="eMail" cssClass="input"/></td>
      </tr>

      <tr>
        <td class="big_table_label"><form:label path="accountancyType"><spring:message text="Тип отчетности"/></form:label></td>
        <td class="big_table_input">
          <form:select path="accountancyType" cssClass="input">
            <form:option value="чековая"></form:option>
            <form:option value="зональная"></form:option>
          </form:select>
            <%--<form:input path="transmission" cssClass="input"/></td>--%>
      </tr>
